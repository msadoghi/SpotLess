...
#define MAX_TXN_IN_FLIGHT (800*BATCH_SIZE)
...
#define RCC_FAIL true
#define CRASH_ROUND 2050
#define CRASH_ID ((CRASH_ROUND*BATCH_SIZE)+98) //400098
#define CRASH_DIVIDER 3
#define CRASH_NODE 2
#define PBFT_FAIL false
